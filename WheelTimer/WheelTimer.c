...
int insert_wt_elem_in_slot(void *data1, void *data2){
...
static void process_wt_reschedule_slotlist(wheel_timer_t *wt){
...
static void _wt_elem_reschedule(wheel_timer_t *wt, wheel_timer_elem_t *wt_elem, 
                    int new_time_interval, wt_opcode_t opcode){
...
void free_wheel_timer_element(wheel_timer_elem_t *wt_elem){
...
void print_wheel_timer(wheel_timer_t *wt){
